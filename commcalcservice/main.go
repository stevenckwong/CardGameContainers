...
func defaultHandler(writer http.ResponseWriter, request *http.Request) {
	fmt.Fprintf(writer, "<html><head><title>Card Game Commission Calculator Service</title></head>")
	fmt.Fprintf(writer, "<body>")
	fmt.Fprintf(writer, "<h1>Service is Running</h1>")
	fmt.Fprintf(writer, "<body>")
	fmt.Fprintf(writer, "<a href='/calcComm?10'>Test</a><br/><br/>")
